...
export default function AboutHero() {
  return (
    <section className="about-hero-root relative min-h-[90vh] w-full bg-[#080D16] text-white overflow-x-hidden flex items-center py-28">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (max-width: 640px) {
          ...
          .about-hero-image-shell > .relative {
            height: auto !important;
            aspect-ratio: 4 / 5 !important;
          }
          .about-mobile-float-cards {
            display: flex;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-8 items-center">
          ...
          {/* Left Content Column */}
          <div className="about-hero-copy col-span-12 lg:col-span-7 flex flex-col items-start text-left max-sm:w-full max-sm:items-center max-sm:text-center">
            {/* Small Badge */}
            ...
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-[1.15] tracking-tight mb-6 max-w-full break-words">
              10+ Years of <br />
            ...
            {/* Paragraph Text */}
            <p className="text-slate-400 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl max-sm:text-base max-sm:leading-relaxed max-sm:break-words">
            ...
            {/* CTA Buttons */}
            <div className="about-hero-buttons flex flex-col sm:flex-row gap-4 w-full sm:w-auto max-sm:w-full">
              <Link
                to="/contact"
                className="about-hero-button inline-flex w-full sm:w-auto items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-400 text-white font-bold rounded-xl shadow-[0_4px_20px_rgba(255,107,0,0.32)] hover:shadow-[0_8px_30px_rgba(255,107,0,0.5)] transition-all duration-300 hover:-translate-y-0.5 group max-sm:text-sm"
              >
                Request a Quote
              ...
              <Link
                to="/products"
                className="about-hero-button inline-flex w-full sm:w-auto items-center justify-center gap-2 px-8 py-4 bg-slate-900/60 hover:bg-slate-800/80 border border-slate-800 hover:border-slate-700 text-white font-semibold rounded-xl backdrop-blur-md transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] group max-sm:text-sm"
              >
                Explore Products
          ...
          <div className="col-span-12 lg:col-span-5 relative flex justify-center items-center max-sm:w-full max-sm:mx-auto">
            {/* Wrapper with subtle custom floating animation */}
            <div className="about-hero-image-shell relative w-full max-w-md lg:max-w-none aspect-[4/5] animate-float-slow group max-sm:max-w-[340px] max-sm:mx-auto max-sm:pb-2">
